...
#define Battery_V_Pin LL_GPIO_PIN_3
#define Battery_V_GPIO_Port GPIOA
#define Heater_NTC_Pin LL_GPIO_PIN_1
#define Heater_NTC_GPIO_Port GPIOB
#define DHT11_IO_Pin LL_GPIO_PIN_12
#define DHT11_IO_GPIO_Port GPIOB
#define HX711_DAT_Pin LL_GPIO_PIN_13
...
#define Heater_PWR_Pin LL_GPIO_PIN_9
#define Heater_PWR_GPIO_Port GPIOB
